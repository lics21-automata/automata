...
lemma unbounded: "\<not>bounded t"
  unfolding bounded_def
  using comp_trans[OF one_step[OF delta.intros(1)] nft_comp_Copy_intro[of False "t"]]
        active_Copy
        comp_trans[OF one_step[OF delta.intros(2)] nft_comp_Skip_intro[of True "t"]]
        active_Skip[of "t + 1"]
